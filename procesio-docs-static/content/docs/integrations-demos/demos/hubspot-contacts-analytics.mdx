...
- you will be needing an HS account - preferably a development account for testing purposes (if you already have an HS account, development or otherwise, skip the underlying steps or take a quick read [here](/docs/integrations-demos/integrations-2-alt/integrations/hubspot) although you still need a test account if you don't want to mess with your production like environment first)
...
If you are slightly familiar with how PROCESIO works then you can continue reading, otherwise, it will be a bit fuzzy but you can of course go through the PROCESIO documentation starting with the [basics,](/docs/overview/processes/process-designer/your-first-process) and easily reach a level where you can understand almost any process and then come back.
