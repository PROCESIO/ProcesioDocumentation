...
- This action is suited only for lists of primitives, and not suited for lists of data models or complex JSON objects. For sorting lists of data models or complex JSON objects, use the [Sort Data Model](/docs/platform-actions/call-api/sort-data-model) action.
