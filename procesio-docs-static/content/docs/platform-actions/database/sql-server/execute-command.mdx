...
First of all, you'll have to enter credentials for the **Execute Command** action. You can find out how to do that [here](/docs/overview/processes/untitled/working-with-credentials/sql-credential).&#x20;
...
**Step 3:&#x20;**&#x53;elect a credential for the database server [(see here how to create one)](/docs/overview/processes/untitled/working-with-credentials/sql-credential)
