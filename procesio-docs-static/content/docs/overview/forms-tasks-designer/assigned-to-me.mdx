...
The assigned to me section displays the currently assigned and completed forms tasks for the user. For more information regarding task check [Task Assignees and Approvals](/docs/overview/forms-tasks-designer/task-assignees-and-approvals).
