...
The select decorator allows you to select your inputs from a predefined list inside your [custom action](/docs/custom-actions/what-is-a-custom-action/your-first-custom-action).
...
&#x20; 1\.     First, you will need to handle the [minimum requirements](/docs/custom-actions/what-is-a-custom-action/prerequisites-and-environment-setup)  for your project by using the Procesio nuget and editing the project file.
...
&#x20; 11.    Create the result [variable](/docs/overview/processes/process-designer/working-with-process-variables).
